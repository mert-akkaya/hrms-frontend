...
export default function WorkExperienceAddModal({curriculumVitae,trigger}) {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      workExperienceService.add(workExperienceModel).then((result)=>{window.location.reload()})
    },
  });
